...
type AparmentRepository interface {
  FindAllAparments(paginationQuery PaginationQuery) []models.AparmentResponse
...
func (r *userRepository) FindAllAparments(paginationQuery PaginationQuery) []models.AparmentResponse {
